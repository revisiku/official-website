...
<li class="breadcrumb-item active">{{ __('Tambah Banner') }}</li>
@endsection
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8 my-auto">
                            <h4 class="mb-0">{{ __('Tambah Banner') }}</h4>
                        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('banner.simpan') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>{{ __('Banner') }} <x-required-indicator /></label>
                                <input
                        ...
                        <div class="form-group col-md-6">
                            <div class="custom-control custom-switch mt-4">
                                <input
                                    ...
                                    @checked(old('is_new_window', false))
                                />
