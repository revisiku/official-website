                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8 my-auto">
                            <h4 class="mb-0">{{ __('Tabel Blog') }}</h4>
                        </div>
                        <div class="col-md-4 d-flex justify-content-end">
                            <a
                                href="{{ route('post.blog.tambah') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                ...
                                                href="{{ url('blog/'.$row->slug) }}?review=1"
                                            >
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <x-forms.button-icon-edit
                                                link="{{ route('post.blog.edit', $row->id) }}"
                                            />
                                            <x-forms.button-icon-delete
                                                link="{{ route('post.blog.hapus', $row->id) }}"
                                            />
                                        </td>
                                    </tr>
                                @endforeach
