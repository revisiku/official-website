...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('post.blog.index') }}">Tabel Blog</a></li>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex justify-content-end">
                            <a href="{{ route('post.blog.index') }}" class="btn btn-dark btn-custom">
                ...
                <div class="card-body">
                    <form action="{{ route('post.blog.ubah', $post->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="form-group col-md-3">
                                ...
                                >
                                    @foreach ($kategori as $row)
                                        <option value="{{ $row->id }}" @selected(old('post_kategori_id', $post->post_kategori_id) == $row->id)>{{ $row->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-3">
                                <div class="custom-control custom-switch mt-4">
                                    <input
                                        ...
                                        @checked(old('is_publish', $post->isPublish()))
                                    />
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>{{ __('Judul Blog') }} <x-required-indicator /></label>
                                <input
                            ...
                            <div class="form-group col-md-6">
                                <label>{{ __('Judul Blog (EN)') }} <x-required-indicator /></label>
                                <input
                                    @class(['form-control', 'is-invalid' => $errors->has('en_title')])
                                    type="text"
                                    name="en_title"
                                    value="{{ old('en_title', $post->en_title) }}"
                                    maxlenght="255"
                                    required
                                />
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                maxlength="300"
                                required
                            >{{ old('en_short', $post->en_short) }}</textarea>
                                <x-forms.invalid-feedback name="title" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                name="en_body"
                            >{{ old('en_body', $post->en_body) }}</textarea>
