...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('Edit Partnership') }}</li>
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('partnership.ubah', $partnership->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="preview">
                                    <img id="image" src="{{ asset($partnership->image) }}">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>{{ __('Logo') }}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input
                                    ...
                                    type="text"
                                    name="link"
                                    value="{{ old('link', $partnership->link) }}"
                                    maxlenght="1000"
                                    required
                                />
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch mt-4">
                                <input
                                    ...
                                    @checked(old('is_publish', $partnership->isPublish()))
                                />
